document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",function(s){s.preventDefault();const r=this.getAttribute("href");if(!r)return;if(r==="#")window.scrollTo({top:0,behavior:"smooth"});else{const a=document.querySelector(r);a&&a.scrollIntoView({behavior:"smooth",block:"start"})}const l=document.querySelector(".js-mobile-menu");l&&!l.classList.contains("hidden")&&d(!1)})});const e={mobileMenuButton:document.querySelector(".js-mobile-menu-open"),closeMenuButton:document.querySelector(".js-mobile-menu-close"),mobileMenu:document.querySelector(".js-mobile-menu"),backdrop:document.querySelector(".js-mobile-menu-backdrop"),modal:document.querySelector(".js-waitlist-modal"),modalBackdrop:document.querySelector(".js-waitlist-modal-backdrop"),modalClose:document.querySelector(".js-waitlist-modal-close"),waitlistButtons:document.querySelectorAll(".js-waitlist-button"),waitlistForm:document.querySelector(".js-waitlist-form"),selectedAppDisplay:document.querySelector(".js-selected-app"),appInput:document.querySelector(".js-app-input"),planInput:document.querySelector(".js-plan-input"),teamModal:document.querySelector(".js-team-waitlist-modal"),teamModalBackdrop:document.querySelector(".js-team-waitlist-modal-backdrop"),teamModalClose:document.querySelector(".js-team-waitlist-modal-close"),teamWaitlistButtons:document.querySelectorAll(".js-team-waitlist-button"),teamWaitlistForm:document.querySelector(".js-team-waitlist-form"),teamPlanInput:document.querySelector(".js-team-plan-input"),managedServersModal:document.querySelector(".js-managed-servers-modal"),managedServersModalBackdrop:document.querySelector(".js-managed-servers-modal-backdrop"),managedServersModalClose:document.querySelector(".js-managed-servers-modal-close"),managedServersButtons:document.querySelectorAll(".js-managed-servers-button"),managedServersForm:document.querySelector(".js-managed-servers-form"),requestAppModal:document.querySelector(".js-request-app-modal"),requestAppModalBackdrop:document.querySelector(".js-request-app-modal-backdrop"),requestAppModalClose:document.querySelector(".js-request-app-modal-close"),requestAppButtons:document.querySelectorAll(".js-request-app-button"),requestAppForm:document.querySelector(".js-request-app-form"),catalogWaitlistModal:document.querySelector(".js-catalog-waitlist-modal"),catalogWaitlistModalBackdrop:document.querySelector(".js-catalog-waitlist-modal-backdrop"),catalogWaitlistModalClose:document.querySelector(".js-catalog-waitlist-modal-close"),catalogWaitlistButtons:document.querySelectorAll(".js-catalog-waitlist-button"),catalogWaitlistForm:document.querySelector(".js-catalog-waitlist-form"),catalogSelectedAppDisplay:document.querySelector(".js-catalog-selected-app"),catalogAppInput:document.querySelector(".js-catalog-app-input")};function d(t){e.mobileMenu&&(e.mobileMenu.classList.toggle("hidden",!t),document.body.style.overflow=t?"hidden":"")}e.mobileMenuButton?.addEventListener("click",()=>d(!0)),e.closeMenuButton?.addEventListener("click",()=>d(!1)),e.backdrop?.addEventListener("click",()=>d(!1)),document.querySelectorAll(".js-mobile-menu a").forEach(t=>{t.addEventListener("click",function(){d(!1)})}),d(!1);const F={small:{winterflow:14,specs:"3 shared vCPU / 4 GB RAM"},medium:{winterflow:42,specs:"4 dedicated vCPU / 16 GB RAM"}},g=document.querySelector(".js-pricing-calculator");if(g){let t=function(a){const o=F[a];o&&r&&l&&(r.textContent=`$${o.winterflow.toFixed(2)}/mo`,l.textContent=o.specs)};const s=g.querySelector(".js-server-select"),r=g.querySelector(".js-winterflow-price"),l=g.querySelector(".js-specs-display");s?.addEventListener("change",a=>{t(a.target.value)}),s&&t(s.value)}const m=document.querySelector(".js-search-input"),b=document.querySelectorAll(".js-filter-checkbox"),x=document.querySelectorAll(".js-plan-filter"),A=document.querySelectorAll(".js-catalog-item"),S=document.querySelector(".js-no-results"),E=document.querySelectorAll(".js-filter-tag");let M;function B(t){M&&clearTimeout(M),t.trim().length!==0&&(M=setTimeout(async()=>{try{await fetch("https://api.flowmitry.com/webhook/winterflow/search",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({search:t.trim()})})}catch(s){console.warn("Search tracking failed:",s)}},500))}function u(){if(!m)return;const t=m.value.toLowerCase(),s=Array.from(b).filter(a=>a.checked).map(a=>a.value),r=Array.from(x).filter(a=>a.checked).map(a=>a.value);let l=0;A.forEach(a=>{const o=a.querySelector(".js-item-name")?.textContent?.toLowerCase()??"",i=a.dataset.type,n=a.dataset.tags?a.dataset.tags.split(","):i?[i]:[],c=a.dataset.availableIn?a.dataset.availableIn.split(","):[],C=[o,a.dataset.keywords||"",a.dataset.alternatives||"",(a.dataset.tags||"").replace(/,/g," "),a.dataset.summary||"",a.dataset.fullDescription||"",a.dataset.license||"",a.dataset.homepageUrl||"",a.dataset.repositoryUrl||"",a.dataset.documentationUrl||""].some(p=>p.toLowerCase().includes(t)),T=s.length===0||s.some(p=>n.includes(p)),j=r.length===0||r.some(p=>c.includes(p)),L=C&&T&&j;a.classList.toggle("hidden",!L),L&&(l+=1)}),S&&S.classList.toggle("hidden",l!==0)}m&&m.addEventListener("input",()=>{u(),B(m.value)}),b.forEach(t=>{t.addEventListener("change",u)}),x.forEach(t=>{t.addEventListener("change",u)}),E.forEach(t=>{t.addEventListener("click",()=>{const s=t.dataset.type;s&&(b.forEach(r=>{r.checked=r.value===s}),u())})});const q=window.location.hash.substring(1).toLowerCase();if(q){const t=document.querySelector(`.js-filter-checkbox[value="${q}"]`);t&&(t.checked=!0,u())}function f(t){!e.modal||!e.modalBackdrop||(e.modal.classList.toggle("hidden",!t),e.modalBackdrop.classList.toggle("hidden",!t),t?(document.body.style.overflow="hidden",e.waitlistForm&&e.waitlistForm.querySelectorAll(".rounded-md.bg-green-50, .rounded-md.bg-red-50").forEach(r=>r.remove())):(document.body.style.overflow="",e.waitlistForm&&(e.waitlistForm.querySelectorAll(".rounded-md.bg-green-50, .rounded-md.bg-red-50").forEach(r=>r.remove()),e.waitlistForm.reset()),e.appInput&&(e.appInput.value=""),e.selectedAppDisplay&&(e.selectedAppDisplay.textContent="your apps")))}e.waitlistButtons.forEach(t=>{t.addEventListener("click",()=>{const s=t.dataset.appName||"your apps";e.selectedAppDisplay&&(e.selectedAppDisplay.textContent=s),e.appInput&&(e.appInput.value=s),f(!0)})}),e.modalClose?.addEventListener("click",()=>f(!1)),e.modalBackdrop?.addEventListener("click",()=>f(!1)),e.waitlistForm&&e.waitlistForm.addEventListener("submit",async t=>{t.preventDefault();const s=e.waitlistForm.querySelector('button[type="submit"]');if(!s)return;const r=s.innerHTML;try{s.disabled=!0,s.innerHTML=`
          ...
          `,e.waitlistForm.insertBefore(c,e.waitlistForm.firstChild),setTimeout(()=>f(!1),5e3)}catch{e.waitlistForm.querySelectorAll(".rounded-md.bg-green-50, .rounded-md.bg-red-50").forEach(i=>i.remove());const o=document.createElement("div");o.className="rounded-md bg-red-50 p-4 mb-6",o.innerHTML=`
            <div class="flex">
              <div class="flex-shrink-0">
          ...
          `,e.waitlistForm.insertBefore(o,e.waitlistForm.firstChild)}finally{s.disabled=!1,s.innerHTML=r}});function v(t){!e.teamModal||!e.teamModalBackdrop||(e.teamModal.classList.toggle("hidden",!t),e.teamModalBackdrop.classList.toggle("hidden",!t),document.body.style.overflow=t?"hidden":"",!t&&e.teamWaitlistForm&&(e.teamWaitlistForm.querySelectorAll(".rounded-md.bg-green-50, .rounded-md.bg-red-50").forEach(r=>r.remove()),e.teamWaitlistForm.reset()))}e.teamWaitlistButtons.forEach(t=>{t.addEventListener("click",()=>v(!0))}),e.teamModalClose?.addEventListener("click",()=>v(!1)),e.teamModalBackdrop?.addEventListener("click",()=>v(!1)),e.teamWaitlistForm&&e.teamWaitlistForm.addEventListener("submit",async t=>{t.preventDefault();const s=e.teamWaitlistForm.querySelector('button[type="submit"]');if(!s)return;const r=s.innerHTML;try{s.disabled=!0,s.innerHTML=`
            <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
              <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
          ...
          `,e.catalogWaitlistForm.insertBefore(o,e.catalogWaitlistForm.firstChild)}finally{s.disabled=!1,s.innerHTML=r}});function w(t){!e.requestAppModal||!e.requestAppModalBackdrop||(e.requestAppModal.classList.toggle("hidden",!t),e.requestAppModalBackdrop.classList.toggle("hidden",!t),document.body.style.overflow=t?"hidden":"",!t&&e.requestAppForm&&(e.requestAppForm.querySelectorAll(".rounded-md.bg-green-50, .rounded-md.bg-red-50").forEach(r=>r.remove()),e.requestAppForm.reset()))}e.requestAppButtons.forEach(t=>{t.addEventListener("click",()=>w(!0))}),e.requestAppModalClose?.addEventListener("click",()=>w(!1)),e.requestAppModalBackdrop?.addEventListener("click",()=>w(!1)),e.requestAppForm&&e.requestAppForm.addEventListener("submit",async t=>{t.preventDefault();const s=e.requestAppForm.querySelector('button[type="submit"]');if(!s)return;const r=s.innerHTML;try{s.disabled=!0,s.innerHTML=`
            <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
              <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
            Submitting...
          `;const l=e.requestAppForm.querySelector('textarea[name="text"]')?.value;if(!(await fetch("https://api.flowmitry.com/webhook/winterflow/request-app",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:l})})).ok)throw new Error("Network response was not ok");e.requestAppForm.querySelectorAll(".rounded-md.bg-green-50, .rounded-md.bg-red-50").forEach(n=>n.remove());const i=document.createElement("div");i.className="rounded-md bg-green-50 p-4 mb-6",i.innerHTML=`
            <div class="flex">
              <div class="flex-shrink-0">
                <svg class="h-5 w-5 text-green-400" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
          ...
          `,e.requestAppForm.insertBefore(i,e.requestAppForm.firstChild),setTimeout(()=>w(!1),5e3)}catch{e.requestAppForm.querySelectorAll(".rounded-md.bg-green-50, .rounded-md.bg-red-50").forEach(i=>i.remove());const o=document.createElement("div");o.className="rounded-md bg-red-50 p-4 mb-6",o.innerHTML=`
            <div class="flex">
              <div class="flex-shrink-0">
                <svg class="h-5 w-5 text-red-400" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586l-1.293-1.293z" clip-rule="evenodd" />
